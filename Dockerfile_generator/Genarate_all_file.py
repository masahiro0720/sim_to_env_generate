...
if __name__ == "__main__":
    ...
    if not success:
        ...
        if not latest_profile:
            ...
            # 【修正点】 ファイル名判定ロジックを柔軟に変更
            profile_name_upper = os.path.basename(latest_profile).upper()
            
            if "ROS" in profile_name_upper:
            ...
            elif "RTM" in profile_name_upper or "OPENRTM" in profile_name_upper:
                ...
                print("Please check if the file name contains 'ROS' or 'RTM'.")
